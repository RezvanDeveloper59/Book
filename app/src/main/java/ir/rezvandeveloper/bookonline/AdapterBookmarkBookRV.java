...
public class AdapterBookmarkBookRV extends RecyclerView.Adapter<AdapterBookmarkBookRV.MyViewHolder> {

    List<ModelBookRv> list;
    Context context;

    public AdapterBookmarkBookRV(List<ModelBookRv> list, Context context) {
        this.list = list;
    ...
    public void onBindViewHolder(@NonNull MyViewHolder holder, int position) {
        ...
        holder.ibBookmarkOffItem.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                editor.remove("AB" + model_bookRv.getName());
                editor.apply();
        ...
        holder.relativeLayout.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(context, PlayBookActivity.class);
