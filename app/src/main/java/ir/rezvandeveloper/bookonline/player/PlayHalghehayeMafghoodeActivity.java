...
public class PlayHalghehayeMafghoodeActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_play_halghehaye_mafghoode);
        ...
        URL = Api.HALGHEHAYE_MAFGHOODE_URL + CURRENT_NAME;
        ...
        ibBookmarkOff.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                // AB == All Book
                editor.putString("HalghehayeMafghoode" + CURRENT_NAME,CURRENT_NAME);
                editor.apply();
            }
        });
        ...
        ibBookmarkOn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                SharedPreferences.Editor editor = Api.sharedPreferences.edit();
                editor.remove("HalghehayeMafghoode" + CURRENT_NAME);
                editor.apply();
            }
        });
        ...
        ib_download_play.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View arg0) {
                new Thread(new Runnable(){
                    @Override
                    public void run() {
                        if (ContextCompat.checkSelfPermission(PlayHalghehayeMafghoodeActivity.this,WRITE_EXTERNAL_STORAGE) != PackageManager.PERMISSION_GRANTED) {
                            requestPermission();
                        } else {
                            URL = Api.HALGHEHAYE_MAFGHOODE_URL + CURRENT_NAME;
                            download(URL);
...
//    }
    ...
    private void readBookmarked(){
        // AB == All Book
        if(Api.sharedPreferences.contains("HalghehayeMafghoode" + CURRENT_NAME)) {
            ibBookmarkOn.setVisibility(View.VISIBLE);
            ibBookmarkOff.setVisibility(View.GONE);
        }else {
            ibBookmarkOn.setVisibility(View.GONE);
    ...
    private void SaveLastNumber(String name) {
        SharedPreferences.Editor editor = Api.sharedPreferences.edit();
        editor.putString("nameHalghehayeMafghoode", name);
        editor.apply();
    }
    ...
    private String previous(String currentName){
        ...
        String nameEnd = HalghehayeMafghoodeActivity.listAllNamesHalghehayeMafghoode.get(0).getName();
        ...
        for (int i = lengthName ; i > 0 ; i--) {
            if (HalghehayeMafghoodeActivity.listAllNamesHalghehayeMafghoode.get(i - 1).getName().equals(currentName)){
                return HalghehayeMafghoodeActivity.listAllNamesHalghehayeMafghoode.get(i - 2).getName();
            }
        }
        return "";
    }
    ...
    private void play(String url){
        ...
        progressDialog = new ProgressDialog(PlayHalghehayeMafghoodeActivity.this);
    ...
    private void increment(){
        ...
        RequestQueue queue = Volley.newRequestQueue(PlayHalghehayeMafghoodeActivity.this);
    ...
    private void requestPermission() {
        if (ActivityCompat.shouldShowRequestPermissionRationale
                (PlayHalghehayeMafghoodeActivity.this, WRITE_EXTERNAL_STORAGE)) {
            reqPermission();
        } else {
            reqPermission();
        }
    ...
    private void reqPermission() {
        ActivityCompat.requestPermissions(PlayHalghehayeMafghoodeActivity.this, new String[] {WRITE_EXTERNAL_STORAGE}, EXTERNAL_MEMORY_REQUEST_CODE);
    }
...
//                Toast.makeText(this, "مجوز رد شد .", Toast.LENGTH_SHORT).show();
    ...
    private void Cast() {
        tv_name = findViewById(R.id.tvTitrHalghehayeMafghoode);
        tv_current_time = findViewById(R.id.tv_current_time_HalghehayeMafghoode);
        tv_total_time = findViewById(R.id.tv_total_time_HalghehayeMafghoode);

        sb_main = findViewById(R.id.sb_main_HalghehayeMafghoode);

        ibBookmarkOff = findViewById(R.id.ibBookmarkOffHalghehayeMafghoode);
        ibBookmarkOn = findViewById(R.id.ibBookmarkOnHalghehayeMafghoode);
        ib_download_play = findViewById(R.id.ib_download_play_HalghehayeMafghoode);
        ib_play = findViewById(R.id.ib_play_HalghehayeMafghoode);
        ib_pause = findViewById(R.id.ib_pause_HalghehayeMafghoode);
        ib_left_jump = findViewById(R.id.ib_left_jump_HalghehayeMafghoode);
        ib_right_jump = findViewById(R.id.ib_right_jump_HalghehayeMafghoode);
        ib_next_jump = findViewById(R.id.ib_next_jump_HalghehayeMafghoode);
        ib_previous_jump = findViewById(R.id.ib_previous_jump_HalghehayeMafghoode);
