...
public class PlayPodcastActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        URL = Api.PODCAST_URL + CURRENT_NAME;
        ...
        ibBookmarkOff.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                // AB == All Book
                editor.putString("Podcast" + CURRENT_NAME,CURRENT_NAME);
                editor.apply();
            }
        });
        ...
        ibBookmarkOn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                SharedPreferences.Editor editor = Api.sharedPreferences.edit();
                editor.remove("Podcast" + CURRENT_NAME);
                editor.apply();
            }
        });
        ...
        ib_download_play.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View arg0) {
                new Thread(new Runnable(){
                    @Override
                    public void run() {
                        if (ContextCompat.checkSelfPermission(PlayPodcastActivity.this,WRITE_EXTERNAL_STORAGE) != PackageManager.PERMISSION_GRANTED) {
                            requestPermission();
                        } else {
                            URL = Api.PODCAST_URL + CURRENT_NAME;
                            download(URL);
...
//    }
    ...
    private void readBookmarked(){
        // AB == All Book
        if(Api.sharedPreferences.contains("Podcast" + CURRENT_NAME)) {
            ibBookmarkOn.setVisibility(View.VISIBLE);
            ibBookmarkOff.setVisibility(View.GONE);
        }else {
            ibBookmarkOn.setVisibility(View.GONE);
    ...
    private void SaveLastNumber(String name) {
        SharedPreferences.Editor editor = Api.sharedPreferences.edit();
        editor.putString("namePodcast", name);
        editor.apply();
    }
    ...
    private String previous(String currentName){
        ...
        String nameEnd = PodcastActivity.listAllNamesPodcast.get(0).getName();
        ...
        for (int i = lengthName ; i > 0 ; i--) {
            if (PodcastActivity.listAllNamesPodcast.get(i - 1).getName().equals(currentName)){
                return PodcastActivity.listAllNamesPodcast.get(i - 2).getName();
            }
        }
        return "";
    }
    ...
    private void play(String url){
        ...
        progressDialog = new ProgressDialog(PlayPodcastActivity.this);
    ...
    private void increment(){
        ...
        RequestQueue queue = Volley.newRequestQueue(PlayPodcastActivity.this);
    ...
    private void requestPermission() {
        if (ActivityCompat.shouldShowRequestPermissionRationale
                (PlayPodcastActivity.this, WRITE_EXTERNAL_STORAGE)) {
            reqPermission();
        } else {
            reqPermission();
        }
    ...
    private void reqPermission() {
        ActivityCompat.requestPermissions(PlayPodcastActivity.this, new String[] {WRITE_EXTERNAL_STORAGE}, EXTERNAL_MEMORY_REQUEST_CODE);
    }
...
//                Toast.makeText(this, "مجوز رد شد .", Toast.LENGTH_SHORT).show();
    ...
    private void Cast() {
        tv_name = findViewById(R.id.tvTitrPodcast);
        tv_current_time = findViewById(R.id.tv_current_time_Podcast);
        tv_total_time = findViewById(R.id.tv_total_time_Podcast);

        sb_main = findViewById(R.id.sb_main_Podcast);

        ibBookmarkOff = findViewById(R.id.ibBookmarkOffPodcast);
        ibBookmarkOn = findViewById(R.id.ibBookmarkOnPodcast);
        ib_download_play = findViewById(R.id.ib_download_play_Podcast);
        ib_play = findViewById(R.id.ib_play_Podcast);
        ib_pause = findViewById(R.id.ib_pause_Podcast);
        ib_left_jump = findViewById(R.id.ib_left_jump_Podcast);
        ib_right_jump = findViewById(R.id.ib_right_jump_Podcast);
        ib_next_jump = findViewById(R.id.ib_next_jump_Podcast);
        ib_previous_jump = findViewById(R.id.ib_previous_jump_Podcast);
