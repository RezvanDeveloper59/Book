...
public class PlayTarkeMoadelateTekrariActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_play_tarke_moadelate_tekrari);
        ...
        URL = Api.TARKE_MOADELATE_TEKRARI_URL + CURRENT_NAME;
        ...
        ibBookmarkOff.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                // AB == All Book
                editor.putString("TarkeMoadelateTekrari" + CURRENT_NAME,CURRENT_NAME);
                editor.apply();
            }
        });
        ...
        ibBookmarkOn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                SharedPreferences.Editor editor = Api.sharedPreferences.edit();
                editor.remove("TarkeMoadelateTekrari" + CURRENT_NAME);
                editor.apply();
            }
        });
        ...
        ib_download_play.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View arg0) {
                new Thread(new Runnable(){
                    @Override
                    public void run() {
                        if (ContextCompat.checkSelfPermission(PlayTarkeMoadelateTekrariActivity.this,WRITE_EXTERNAL_STORAGE) != PackageManager.PERMISSION_GRANTED) {
                            requestPermission();
                        } else {
                            URL = Api.TARKE_MOADELATE_TEKRARI_URL + CURRENT_NAME;
                            download(URL);
...
//    }
    ...
    private void readBookmarked(){
        // AB == All Book
        if(Api.sharedPreferences.contains("TarkeMoadelateTekrari" + CURRENT_NAME)) {
            ibBookmarkOn.setVisibility(View.VISIBLE);
            ibBookmarkOff.setVisibility(View.GONE);
        }else {
            ibBookmarkOn.setVisibility(View.GONE);
    ...
    private void SaveLastNumber(String name) {
        SharedPreferences.Editor editor = Api.sharedPreferences.edit();
        editor.putString("nameTarkeMoadelateTekrari", name);
        editor.apply();
    }
    ...
    private String previous(String currentName){
        ...
        String nameEnd = TarkeMoadelateTekrariActivity.listAllNamesTarkeMoadelateTekrari.get(0).getName();
        ...
        for (int i = lengthName ; i > 0 ; i--) {
            if (TarkeMoadelateTekrariActivity.listAllNamesTarkeMoadelateTekrari.get(i - 1).getName().equals(currentName)){
                return TarkeMoadelateTekrariActivity.listAllNamesTarkeMoadelateTekrari.get(i - 2).getName();
            }
        }
        return "";
    }
    ...
    private void play(String url){
        ...
        progressDialog = new ProgressDialog(PlayTarkeMoadelateTekrariActivity.this);
    ...
    private void increment(){
        ...
        RequestQueue queue = Volley.newRequestQueue(PlayTarkeMoadelateTekrariActivity.this);
    ...
    private void requestPermission() {
        if (ActivityCompat.shouldShowRequestPermissionRationale
                (PlayTarkeMoadelateTekrariActivity.this, WRITE_EXTERNAL_STORAGE)) {
            reqPermission();
        } else {
            reqPermission();
        }
    ...
    private void reqPermission() {
        ActivityCompat.requestPermissions(PlayTarkeMoadelateTekrariActivity.this, new String[] {WRITE_EXTERNAL_STORAGE}, EXTERNAL_MEMORY_REQUEST_CODE);
    }
...
//                Toast.makeText(this, "مجوز رد شد .", Toast.LENGTH_SHORT).show();
    ...
    private void Cast() {
        tv_name = findViewById(R.id.tvTitrTarkeMoadelateTekrari);
        tv_current_time = findViewById(R.id.tv_current_time_TarkeMoadelateTekrari);
        tv_total_time = findViewById(R.id.tv_total_time_TarkeMoadelateTekrari);

        sb_main = findViewById(R.id.sb_main_TarkeMoadelateTekrari);

        ibBookmarkOff = findViewById(R.id.ibBookmarkOffTarkeMoadelateTekrari);
        ibBookmarkOn = findViewById(R.id.ibBookmarkOnTarkeMoadelateTekrari);
        ib_download_play = findViewById(R.id.ib_download_play_TarkeMoadelateTekrari);
        ib_play = findViewById(R.id.ib_play_TarkeMoadelateTekrari);
        ib_pause = findViewById(R.id.ib_pause_TarkeMoadelateTekrari);
        ib_left_jump = findViewById(R.id.ib_left_jump_TarkeMoadelateTekrari);
        ib_right_jump = findViewById(R.id.ib_right_jump_TarkeMoadelateTekrari);
        ib_next_jump = findViewById(R.id.ib_next_jump_TarkeMoadelateTekrari);
        ib_previous_jump = findViewById(R.id.ib_previous_jump_TarkeMoadelateTekrari);
