...
public class AdapterMotefaregheRV extends RecyclerView.Adapter<AdapterMotefaregheRV.MyViewHolder> {

    List<ModelBookRv> list;
    Context context;

    public AdapterMotefaregheRV(List<ModelBookRv> list, Context context) {
        this.list = list;
    ...
    public MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.items_motefareghe_rv, parent, false);
    ...
    public class  MyViewHolder extends RecyclerView.ViewHolder {
        ...
        public MyViewHolder(@NonNull View itemView) {
            super(itemView);
            ll_parent_rv = itemView.findViewById(R.id.llItemTalkQuestionM);
            tv_item_rv = itemView.findViewById(R.id.tv_item_m);
