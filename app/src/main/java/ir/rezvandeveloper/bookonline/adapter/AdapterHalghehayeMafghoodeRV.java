...
public class AdapterHalghehayeMafghoodeRV extends RecyclerView.Adapter<AdapterHalghehayeMafghoodeRV.MyViewHolder> {

    List<ModelBookRv> list;
    Context context;

    public AdapterHalghehayeMafghoodeRV(List<ModelBookRv> list, Context context) {
        this.list = list;
