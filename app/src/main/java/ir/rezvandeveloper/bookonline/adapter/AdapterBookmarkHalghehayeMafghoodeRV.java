...
public class AdapterBookmarkHalghehayeMafghoodeRV extends RecyclerView.Adapter<AdapterBookmarkHalghehayeMafghoodeRV.MyViewHolder> {

    List<ModelBookRv> list;
    Context context;

    public AdapterBookmarkHalghehayeMafghoodeRV(List<ModelBookRv> list, Context context) {
        this.list = list;
    ...
    public void onBindViewHolder(@NonNull MyViewHolder holder, int position) {
        ...
        holder.ibMotefaregheOffItem.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                editor.remove("HalghehayeMafghoode" + model_bookRv.getName());
                editor.apply();
        ...
        holder.relativeLayout.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(context, PlayHalghehayeMafghoodeActivity.class);
