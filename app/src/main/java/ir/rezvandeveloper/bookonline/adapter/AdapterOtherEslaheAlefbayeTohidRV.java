...
public class AdapterOtherEslaheAlefbayeTohidRV extends RecyclerView.Adapter<AdapterOtherEslaheAlefbayeTohidRV.MyViewHolder> {

    List<ModelBookRv> list;
    Context context;

    public AdapterOtherEslaheAlefbayeTohidRV(List<ModelBookRv> list, Context context) {
        this.list = list;
    ...
    public MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.items_other_eslahe_alefbaye_tihid_rv, parent, false);
    ...
    public class  MyViewHolder extends RecyclerView.ViewHolder {
        ...
        public MyViewHolder(@NonNull View itemView) {
            super(itemView);
            ll_parent_rv = itemView.findViewById(R.id.llItemRvOtherEslaheAlefbayeTohid);
            tv_item_rv = itemView.findViewById(R.id.tv_item_rvOtherEslaheAlefbayeTohid);
