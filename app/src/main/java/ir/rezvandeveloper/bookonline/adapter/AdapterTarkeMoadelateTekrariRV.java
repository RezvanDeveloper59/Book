...
public class AdapterTarkeMoadelateTekrariRV extends RecyclerView.Adapter<AdapterTarkeMoadelateTekrariRV.MyViewHolder> {

    List<ModelBookRv> list;
    Context context;

    public AdapterTarkeMoadelateTekrariRV(List<ModelBookRv> list, Context context) {
        this.list = list;
