...
public class AdapterBookmarkPodcastRV extends RecyclerView.Adapter<AdapterBookmarkPodcastRV.MyViewHolder> {

    List<ModelBookRv> list;
    Context context;

    public AdapterBookmarkPodcastRV(List<ModelBookRv> list, Context context) {
        this.list = list;
    ...
    public void onBindViewHolder(@NonNull MyViewHolder holder, int position) {
        ...
        holder.ibOffItem.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                holder.ibOffItem.setVisibility(View.GONE);

                SharedPreferences.Editor editor = Api.sharedPreferences.edit();
                editor.remove("Podcast" + model_bookRv.getName());
                editor.apply();
    ...
    public class  MyViewHolder extends RecyclerView.ViewHolder {
        ...
        AppCompatImageButton ibOffItem;
        public MyViewHolder(@NonNull View itemView) {
            ...
            ibOffItem = itemView.findViewById(R.id.ibMotefaregheOffItem);
